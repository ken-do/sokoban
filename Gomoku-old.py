...
class SmartRandomAgentOldVersion:
    def __init__(self, name="SmartRandom"):
        self.name = name

    def get_move(self, game: GomokuGameOldVersion) -> Tuple[int, int]:
...
class MinimaxAgentOldVersion:
    ...
    def evaluate_board(self, game: GomokuGameOldVersion, original_player: int) -> float:
        """
    ...
    def _get_smart_moves(self, game: GomokuGameOldVersion) -> List[Tuple[int, int]]:
...
if __name__ == "__main__":
    ...
    minimax_ai = MinimaxAgentOldVersion(name="Minimax_Agent", max_depth=TEST_DEPTH, search_radius=2)

    opponent = SmartRandomAgentOldVersion(name="Random_Agent")
